<style>
  /* ===================================================
     RENEGADE AI v5.3 · 小白修复版
     说明：仅修正了字体大小，不做其他改动，防止白屏
     =================================================== */
  ...
  /* --- 这里是修复的关键：修正了 clamp 数值顺序 --- */
  .cover-title {
    font-family: var(--display);
    /* 修正前：clamp(18.8rem, 10vw, 9rem)  ← 这个顺序是错的，导致字消失了 */
    /* 修正后：从小到大 */
    font-size: clamp(4rem, 12vw, 10rem); /* 现在字号很大且正常显示 */
    line-height: 0.9;
    color: var(--white);
    letter-spacing: 3px;
    margin: 0 0 10px 0;
